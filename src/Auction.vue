    ...
    <nav class="navbar fixed-top navbar-dark bg-primary">
      ...
      <form class="form-inline">
        ...
        <div v-if="loggedIn">
          ...
          <li class="nav-item">
            <router-link class="nav-link" style="color:white;" to="/" v-on:click.native="logout()">Logout</router-link>
          </li>
        </div>

        <div v-else>
          <li class="nav-item">
            <router-link class="nav-link" style="color:white;" to="/">Create Account</router-link>
          </li>
        </div>
      </form>
    </nav>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div v-else-if="bidStatus === 3" style="color: red;">
              ...
              <router-link to="/" data-dismiss="modal">here</router-link>
              to login/sign up
            </div>
